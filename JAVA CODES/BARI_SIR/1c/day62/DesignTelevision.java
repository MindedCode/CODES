...
public class DesignTelevision {
    public static void main(String[] args) {
        short max = 5>6 ? 5 : 6;   // superess warning(Dead code):  here is no any expresion only provide non-zero value, directly max 6 use kr skte ho.
